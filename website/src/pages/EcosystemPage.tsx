...
const LIVE_COVERAGE_ZONES: CityCoverageCard[] = [
  {
    id: "noida-central",
    zone: "Noida Central & High-Density Residential",
    status: "100% Live & Operational",
    areas: "Sector 62, 75, 76, 78, 74, 77, 50, 51, 18, 27",
    avgPickup: "8 – 11 Mins",
    hubs: "32 Active Partner Hubs",
    captains: "85+ Verified Captains",
    color: "border-emerald-200 bg-emerald-50/40",
    sectors: [
      { name: "Sector 62 (Logix Cyber Park / IT Hub / D-Block)", pincode: "201309", eta: "8 Mins" },
      { name: "Sector 75 (Golf City / Apex Athena / Maxblis)", pincode: "201301", eta: "8 Mins" },
      { name: "Sector 76 (Amrapali Silicon City / Skytech)", pincode: "201301", eta: "8 Mins" },
      { name: "Sector 78 (Antriksh Golf / Hyde Park / Mahagun)", pincode: "201301", eta: "7 Mins" },
      { name: "Sector 74 & 77 (Supertech Capetown / Grand Omaxe)", pincode: "201301", eta: "9 Mins" },
  ...
  {
    id: "noida-expressway",
    zone: "Noida Expressway & Tech Corridor",
    status: "100% Live & Operational",
    areas: "Sector 137, 142, 90, 128, 135, 150",
    avgPickup: "9 – 12 Mins",
    hubs: "24 Active Partner Hubs",
    captains: "60+ Verified Captains",
    color: "border-emerald-200 bg-emerald-50/40",
    sectors: [
      { name: "Sector 90 (Bhutani Alphathum / Express HQ)", pincode: "201305", eta: "7 Mins" },
      { name: "Sector 137 (Paras Tierea / Exotica Fresco / Supertech)", pincode: "201305", eta: "8 Mins" },
      { name: "Sector 142 & 143 (Advant Navis / Gulshan Ikebana)", pincode: "201305", eta: "9 Mins" },
      { name: "Sector 128 & 132 (Jaypee Greens / Wish Town / Genesis)", pincode: "201304", eta: "10 Mins" },
      { name: "Sector 135 (Express Trade Towers / Assotech)", pincode: "201304", eta: "9 Mins" },
      { name: "Sector 150 (Sports City / ATS Pristine / Godrej)", pincode: "201310", eta: "11 Mins" },
    ],
  },
  {
    id: "noida-ext",
    zone: "Greater Noida & Noida Extension",
    status: "100% Live & Operational",
    areas: "Gaur City 1 & 2, TechZone 4, Pari Chowk, Alpha 1 & 2",
    avgPickup: "10 – 14 Mins",
    hubs: "18 Active Partner Hubs",
    captains: "45+ Verified Captains",
    color: "border-emerald-200 bg-emerald-50/40",
    sectors: [
      { name: "Gaur City 1 & 2 (1st to 16th Avenue / Galleria)", pincode: "201318", eta: "10 Mins" },
      { name: "TechZone 4 (Cherry County / Nirala / Panchsheel)", pincode: "201306", eta: "11 Mins" },
      { name: "Pari Chowk & Alpha 1 / 2 Commercial Belt", pincode: "201308", eta: "12 Mins" },
      { name: "Knowledge Park 1, 2, 3 (Institutional Zone)", pincode: "201310", eta: "12 Mins" },
    ],
  },
];
...
export function EcosystemPage({
  ...
  const [expandedZoneIds, setExpandedZoneIds] = useState<string[]>(["noida-central"]);
