/**
 * QuickPress Partner Authentication Service — Native Backend Auth & OneSignal.
 *
 * Direct Phone OTP and JWT session management without 3rd party auth lock-in.
 * Upon login, automatically syncs external partner ID with OneSignal push engine.
 */
...
/** POST /api/auth/phone/send-otp — Sends OTP directly via backend. */
...
/** POST /api/auth/phone/verify — verifies SMS OTP and returns Partner JWT AuthSession. */
